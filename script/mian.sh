...
curl -o i-5.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_50.txt
curl -o i-6.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_44.txt
