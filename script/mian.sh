...
curl -o i-4.txt https://easylist.to/easylist/easylist.txt
curl -o i-5.txt https://www.i-dont-care-about-cookies.eu/abp/
curl -o i-6.txt https://easylist-downloads.adblockplus.org/antiadblockfilters.txt
curl -o i-7.txt https://raw.githubusercontent.com/xinggsf/Adblock-Plus-Rule/master/rule.txt
curl -o i-8.txt https://raw.githubusercontent.com/uBlockOrigin/uAssets/master/filters/filters.txt
curl -o i-9.txt https://raw.githubusercontent.com/uBlockOrigin/uAssets/master/filters/resource-abuse.txt
curl -o i-10.txt https://raw.githubusercontent.com/jdlingyu/ad-wars/master/sha_ad_hosts
curl -o i-11.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_2.txt
curl -o i-12.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_38.txt
curl -o i-13.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_5.txt
curl -o i-14.txt https://www.kbsml.com/wp-content/uploads/adblock/adguard/adg-kall.txt
