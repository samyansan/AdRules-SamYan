...
curl -o i-4.txt https://raw.githubusercontent.com/uniartisan/adblock_list/master/adblock.txt
curl -o i-5.txt https://raw.githubusercontent.com/uBlockOrigin/uAssets/master/filters/resource-abuse.txt
curl -o i-6.txt https://raw.githubusercontent.com/damengzhu/banad/main/jiekouAD.txt
curl -o i-7.txt https://easylist-downloads.adblockplus.org/antiadblockfilters.txt
curl -o i-8.txt https://easylist-downloads.adblockplus.org/abp-filters-anti-cv.txt 
