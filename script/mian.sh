...
curl -o i-2.txt https://raw.githubusercontent.com/o0HalfLife0o/list/master/ad.txt
curl -o i-3.txt https://raw.githubusercontent.com/xinggsf/Adblock-Plus-Rule/master/mv.txt
